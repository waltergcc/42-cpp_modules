...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/04 19:26:11 by wcorrea-          #+#    #+#             */
/*   Updated: 2023/09/06 10:16:36 by wcorrea-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ScalarConverter::convert(std::string const &input)
{
	...
	switch (type)
	{
		case NAN_INF:
			...
			break;
		case ERROR:
			std::cout << RED << "Error: Impossible to print or input not convertable" << std::endl;
			break;
		case CHAR:
